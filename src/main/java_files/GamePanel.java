...
import javax.swing.*;
 ...
 class GamePanel extends JPanel implements KeyListener , Runnable{
    ...
    int[][] map = {
        ...
        {1, 1, 1, 1, 2, 1, 2, 1, 1, 1, 2, 1, 1, 2, 1, 2, 1, 1, 1, 1}, 
    ...
    Pacman pacman = new Pacman(TILE_SIZE * 10,10*TILE_SIZE, 'e');
    YellowGhost yellowGhost = new YellowGhost(TILE_SIZE*18,TILE_SIZE, pacman,map);
    RedGhost redGhost = new RedGhost(TILE_SIZE, 20*TILE_SIZE, pacman, map);
    PurpleGhost purpleGhost = new PurpleGhost(18*TILE_SIZE, 20*TILE_SIZE, pacman, map,redGhost);
    TurquiseGhost turquiseGhost = new TurquiseGhost(TILE_SIZE,TILE_SIZE, pacman, map);
